...
PathGasMeter::PathGasMeter(AssemblyItems const& _items, solidity::VVMVersion _vvmVersion):
	m_items(_items), m_vvmVersion(_vvmVersion)
{
...
GasMeter::GasConsumption PathGasMeter::handleQueueItem()
{
	...
	GasMeter meter(state, m_vvmVersion, path->largestMemoryAccess);
