...
<https://gitter.im/vapory/solidity-dev>`_ (different from the one mentioned above, this on is
focused on compiler and language development instead of language use) first.


Finally, please make sure you respect the `coding style
<https://raw.githubusercontent.com/vapory/solidity/develop/CODING_STYLE.md>`_
...
to run a subset of the tests that do not require ``cpp-vapory``, use
...
Then you run the actual tests: ``./build/test/soltest -- --ipcpath /tmp/testvap/gvap.ipc --testpath ./test``.

To run a subset of tests, filters can be used:
``soltest -t TestSuite/TestName -- --ipcpath /tmp/testvap/gvap.ipc --testpath ./test``,
