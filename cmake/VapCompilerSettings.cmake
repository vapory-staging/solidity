#------------------------------------------------------------------------------
# VapCompilerSettings.cmake
#
# CMake file for cpp-vapory project which specifies our compiler settings
# for each supported platform and build configuration.
#
# The documentation for cpp-vapory is hosted at http://cpp-vapory.org
#
# Copyright (c) 2014-2016 cpp-vapory contributors.
#------------------------------------------------------------------------------
...
include(VapCheckCXXCompilerFlag)

vap_add_cxx_compiler_flag_if_supported(-fstack-protector-strong have_stack_protector_strong_support)
if(NOT have_stack_protector_strong_support)
	vap_add_cxx_compiler_flag_if_supported(-fstack-protector)
endif()

vap_add_cxx_compiler_flag_if_supported(-Wimplicit-fallthrough)
...
if (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang"))
	...
	set(CMAKE_CXX_FLAGS_DEBUG          "-O0 -g -DVAP_DEBUG")
	...
	elseif ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
		...
		if (EMSCRIPTEN)
			...
			add_definitions(-DVAP_EMSCRIPTEN=1)
		endif()
	endif()
...
if (PROFILING AND (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")))
	...
	add_definitions(-DVAP_PROFILING_GPERF)
