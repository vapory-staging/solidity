...
{
	string forks;
	if (test::Options::get().vvmVersion() >= solidity::VVMVersion::tangerineWhistle())
		forks += "\"EIP150ForkBlock\": \"0x00\",\n";
	if (test::Options::get().vvmVersion() >= solidity::VVMVersion::spuriousDragon())
		forks += "\"EIP158ForkBlock\": \"0x00\",\n";
	if (test::Options::get().vvmVersion() >= solidity::VVMVersion::byzantium())
		forks += "\"byzantiumForkBlock\": \"0x00\",\n";
	if (test::Options::get().vvmVersion() >= solidity::VVMVersion::constantinople())
